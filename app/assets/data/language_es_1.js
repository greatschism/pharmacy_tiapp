module.exports = {
	"data" : {
		...
		"remindersMedLblFrequencyDaily" : "es-%s: %s",
		"remindersMedLblFrequencyWeekly" : "es-%s: %s",
		"remindersMedLblFrequencyMonthly" : "es-Every month: on the %s",
		"remindersMedLblFrequencyOnADay" : "es-On %s: every %",
		"remindersMedLblFrequencyPeriod" : "es-Every %s",
