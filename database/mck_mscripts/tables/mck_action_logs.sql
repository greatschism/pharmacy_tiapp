...
-- Dumping structure for table wg_mscripts.mck_action_logs
DROP TABLE IF EXISTS `mck_action_logs`;
CREATE TABLE IF NOT EXISTS `mck_action_logs` (
  ...
  `mck_request_body` blob COMMENT 'PDX request body',
  `mck_response_body` blob COMMENT 'PDX response body',
  ...
  PRIMARY KEY (`id`),
  KEY `FK_pdx_action_logs_action_log_id` (`action_log_id`),
