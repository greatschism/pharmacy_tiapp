...
-- Dumping structure for table wg_mscripts.role_links_history
DROP TABLE IF EXISTS `role_links_history`;
CREATE TABLE IF NOT EXISTS `role_links_history` (
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Contains links previously associated with AC user roles';
