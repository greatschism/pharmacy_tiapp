...
-- Dumping structure for table wg_mscripts.onphone_reminder_log_histories
DROP TABLE IF EXISTS `onphone_reminder_log_histories`;
CREATE TABLE IF NOT EXISTS `onphone_reminder_log_histories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key of the table',
  `client_id` int(10) unsigned NOT NULL COMMENT 'FK to the clients table',
  `onphone_reminder_logs_id` int(10) unsigned DEFAULT NULL COMMENT 'The id of record in onphone_reminder_logs table',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='History Logs all the individual onPhone Reminders';
