...
-- Dumping structure for table wg_mscripts.config_messages
...
CREATE TABLE IF NOT EXISTS `config_messages` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_cm_client_id` (`client_id`),
  CONSTRAINT `FK_config_messages_client_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Configurable messages';
