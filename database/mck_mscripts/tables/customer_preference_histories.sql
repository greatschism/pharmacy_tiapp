...
-- Dumping structure for table wg_mscripts.customer_preference_histories
DROP TABLE IF EXISTS `customer_preference_histories`;
CREATE TABLE IF NOT EXISTS `customer_preference_histories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'PK of the table',
  `client_id` int(10) unsigned NOT NULL COMMENT 'FK to the clients table',
  `customer_preference_id` int(10) unsigned NOT NULL COMMENT 'ID of the customer_preferences table record',
  ...
  `mobile_app_active` char(1) DEFAULT NULL COMMENT 'Unused field',
  `text_msg_active` char(1) DEFAULT NULL COMMENT 'Flag to start/stop SMS',
  `email_msg_active` char(1) DEFAULT NULL COMMENT 'Flag to start/stop Email',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Updated/Deleted customer preferences';
