...
-- Dumping structure for table wg_mscripts.users_history
DROP TABLE IF EXISTS `users_history`;
CREATE TABLE IF NOT EXISTS `users_history` (
  `id` int(11) unsigned NOT NULL COMMENT 'ID of the admin console user. Primary key of the table',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='This table stores all Admin Console user details';
