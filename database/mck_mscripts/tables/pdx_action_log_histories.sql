...
-- Dumping structure for table wg_mscripts.pdx_action_log_histories
DROP TABLE IF EXISTS `pdx_action_log_histories`;
CREATE TABLE IF NOT EXISTS `pdx_action_log_histories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'PK of the table',
  `client_id` int(10) unsigned NOT NULL COMMENT 'FK to the clients table',
  `pdx_action_logs_id` int(10) unsigned DEFAULT NULL COMMENT 'The id of record in pdx_action_logs table',
  ...
  `pdx_response_body` mediumblob COMMENT 'PDX response body',
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COMMENT='History table for pdx request/response';
