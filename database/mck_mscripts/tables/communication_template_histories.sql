...
-- Dumping structure for table wg_mscripts.communication_template_histories
DROP TABLE IF EXISTS `communication_template_histories`;
CREATE TABLE IF NOT EXISTS `communication_template_histories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'PK of the table',
  `client_id` int(10) unsigned NOT NULL COMMENT 'FK to the clients table',
  `communication_id` int(10) unsigned NOT NULL COMMENT 'Refers to id of table communications',
  `communication_name` varchar(60) NOT NULL COMMENT 'Name as to be displayed on the admin screen',
  `changed_template_type` varchar(50) DEFAULT NULL COMMENT 'Signifies which of the template types changed-sms,email or onPhone',
