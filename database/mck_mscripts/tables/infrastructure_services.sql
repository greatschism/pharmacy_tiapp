...
-- Dumping structure for table wg_mscripts.infrastructure_services
...
CREATE TABLE IF NOT EXISTS `infrastructure_services` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_infrastructure_services_1` (`client_id`),
  CONSTRAINT `FK_infrastructure_services_client_id` FOREIGN KEY (`client_id`) REFERENCES `clients` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Infrastructure services and their status are available here';
