...
-- Dumping structure for table wg_mscripts.refill_reminder_instance_histories
DROP TABLE IF EXISTS `refill_reminder_instance_histories`;
CREATE TABLE IF NOT EXISTS `refill_reminder_instance_histories` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'PK of the table',
  `client_id` int(10) unsigned NOT NULL COMMENT 'FK to the clients table',
  `refill_reminder_instance_id` int(10) unsigned NOT NULL COMMENT 'The id of the record in the refill_reminder_instances table',
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 COMMENT='Table to store the history of the refill reminder instances';
