	...
	"data" : [{
		...
		"children" : [{
			"items" : [{
					...
					"items" : [{
						...
						"children" : [{
							"items" : [{
								...
								"apiName" : "Label",
								"classes" : ["margin-top-extra-large", "margin-bottom-extra-large", "margin-left-medium", "h4", "fg-color", "touch-disabled"],
								"properties" : {
									"textid" : "titlePrescriptions"
								}
							}]
				...
				"children" : [{
					"items" : [{
						...
						"children" : [{
							"items" : [{
								"apiName" : "Label",
								"classes" : ["margin-top-extra-large", "margin-bottom-extra-large", "margin-left", "i4", "primary-fg-color", "touch-disabled", "icon-refill-camera"]
							}, {
								"apiName" : "Label",
								"classes" : ["margin-top-extra-large", "margin-bottom-extra-large", "margin-left-medium", "h4", "fg-color", "touch-disabled"],
								"properties" : {
				...
				"children" : [{
					"items" : [{
						...
						"children" : [{
							"items" : [{
								"apiName" : "Label",
								"classes" : ["margin-top-extra-large", "margin-bottom-extra-large", "margin-left", "i4", "primary-fg-color", "touch-disabled", "icon-thick-notification"]
							}, {
								"apiName" : "Label",
								"classes" : ["margin-top-extra-large", "margin-bottom-extra-large", "margin-left-medium", "h4", "fg-color", "touch-disabled"],
								"properties" : {
				...
				"feature_name" : "is_delivery_option_enabled",
				"navigation" : {
					"ctrl" : "orderHistory"
				}
			}, {
